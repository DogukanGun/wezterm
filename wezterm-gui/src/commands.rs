...
pub fn derive_command_from_key_assignment(action: &KeyAssignment) -> Option<CommandDef> {
    Some(match action {
        ...
        SpawnAIPane => CommandDef {
            brief: "Spawn AI pane".into(),
            doc: "Open an AI chat pane".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &[],
            icon: Some("md_terminal"),
        },
        SpawnSolanaAIPane => CommandDef {
            brief: "Spawn Solana AI pane".into(),
            doc: "Open a Solana AI agent pane".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &[],
            icon: Some("md_terminal"),
